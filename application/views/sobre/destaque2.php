...
<table class="table_modulo">
	<tr>
		<td><a href="<?php echo URL::site('iframes/destaque'); ?>" target="destaque"><img src="<?php echo URL::site("resources/img/icon/before.png")?>"></a>
		<td><img width="50" height="50" src="<?php echo URL::site("resources/img/icon/6.png")?>">
		<td><p><?php echo $paragrafo2; ?></p>
		<?php if ($paragrafo3 != "") {?>
		<td><a href="<?php echo URL::site('iframes/destaque3'); ?>" target="destaque"><img src="<?php echo URL::site("resources/img/icon/next.png")?>"></a>
		<?php } ?>
</table>
</div>
</body>
